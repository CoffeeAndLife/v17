...
<div class="hd-info1 w1200">
    <div class="logo f-l">
        <h1><a href="#" title="中林网站"><img src="../static/images/logo.jpg" /></a></h1>
    </div>
        ...
        <div class="dt-if1-l f-l">
            <div class="dt-if1-datu">
                <ul qie-da="">
                    ...
                    <li><a href="#"><img src="../static/images/dt-if1-l-tuda2.gif" /></a></li>
                    <li><a href="#"><img src="../static/images/dt-if1-l-tuda3.gif" /></a></li>
                    <li><a href="#"><img src="../static/images/dt-if1-l-tuda4.gif" /></a></li>
                    <li><a href="#"><img src="../static/images/dt-if1-l-tuda5.gif" /></a></li>
                    <li><a href="#"><img src="../static/images/dt-if1-l-tuda6.gif" /></a></li>
                    <li><a href="#"><img src="../static/images/dt-if1-l-tuda7.gif" /></a></li>
                    <div style="clear:both;"></div>
                </ul>
            </div>
            <div class="dt-if1-qietu">
                <a class="dt-qie-left f-l" href="JavaScript:;"><img src="../static/images/dt-if1-qietu-left.gif" /></a>
                <div class="dt-qie-con f-l">
                    <ul qie-xiao="">
                        <li class="current"><a href="#"><img src="../static/images/dt-if1-qietu1.gif" /></a></li>
                        <li><a href="#"><img src="../static/images/dt-if1-qietu2.gif" /></a></li>
                        <li><a href="#"><img src="../static/images/dt-if1-qietu3.gif" /></a></li>
                        <li><a href="#"><img src="../static/images/dt-if1-qietu4.gif" /></a></li>
                        <li><a href="#"><img src="../static/images/dt-if1-qietu5.gif" /></a></li>
                        <li><a href="#"><img src="../static/images/dt-if1-qietu6.gif" /></a></li>
                        <li><a href="#"><img src="../static/images/dt-if1-qietu7.gif" /></a></li>
                        <div style="clear:both;"></div>
                    </ul>
                </div>
                <a class="dt-qie-right f-r" href="JavaScript:;"><img src="../static/images/dt-if1-qietu-right.gif" /></a>
            </div>
            <div class="dt-if1-fx">
                <span>商品编码:128618586</span>
                <p>分享到：<a href="#"><img src="../static/images/dt-xl.gif" /></a><a href="#"><img src="../static/images/dt-kj.gif" /></a><a href="#"><img src="../static/images/dt-wx.gif" /></a></p>
            </div>
        </div>
